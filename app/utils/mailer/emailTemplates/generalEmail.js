// This is the general email template
              ...
              content: {
                ...
                html:
                    `
                      ...
                      <h4 class="text-center" style="text-align: center; color: inherit; font-family: Helvetica,Arial,sans-serif; font-weight: normal; line-height: 1.3; word-wrap: normal; font-size: 24px; margin: 0 0 10px; padding: 0;" align="center">Message from ${companyName}</h4>
                      </th>
                      ...
                      <p class="text-center" style="text-align: center; color: #0a0a0a; font-family: Helvetica,Arial,sans-serif; font-weight: normal; line-height: 19px; font-size: 16px; margin: 0 0 10px; padding: 0;" align="center">You have been sent a playbook through <a href="http://qrtrmstr.com" style="color: #EE6352; font-family: Helvetica,Arial,sans-serif; font-weight: normal; text-align: left; line-height: 1.3; text-decoration: none; margin: 0; padding: 0;">Quartermaster</a></p>
                      <p class="text-center" style="text-align: center; color: #0a0a0a; font-family: Helvetica,Arial,sans-serif; font-weight: normal; line-height: 19px; font-size: 16px; margin: 0 0 10px; padding: 0;" align="center">Click the link below to gain access the playbook.</p>
