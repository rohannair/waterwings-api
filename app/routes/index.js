...
module.exports = function configure(router) {
  ...
  .get('/emails', middleware.tokenCheck, middleware.adminCheck, emailController.GET_ALL)
  .get('/emails/:id', middleware.tokenCheck, middleware.adminCheck, emailController.GET_ONE)
