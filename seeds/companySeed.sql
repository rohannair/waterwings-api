...
INSERT INTO emails (name, description, body, role_id, company_id) VALUES
  ('Welcome Email', 'Welcome email template', '{}', null ,'nGLHsVI'),
  ('Forgot Password Email', 'Forgot password email template', '{}', null ,'nGLHsVI');
